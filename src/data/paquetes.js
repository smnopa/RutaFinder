export const paquetes = [
    ...
    paquetes: [
      {
        ...
        descripcion: "Explora el icónico cerro de Monserrate, un lugar donde la naturaleza, la espiritualidad y la cultura convergen para ofrecerte una experiencia inolvidable.",
        ...
        descripciondetalles: [
          "Recorrido por el santuario y sus alrededores, con vistas panorámicas únicas.",
          "Disfruta de tiempo libre para explorar la gastronomía y las artesanías locales."
        ],
        ...
        contentData: [
          {
            titulo: "Historia y Cultura de Monserrate",
            description: "Monserrate es mucho más que un cerro; es un símbolo de la historia, la espiritualidad y la cultura bogotana.",
            historia: {
              title: "Historia",
              content: "Monserrate se remonta al siglo XVII, cuando se erigió su primer santuario como lugar de peregrinación para los fieles. Desde entonces, ha sido testigo de numerosos eventos históricos que han moldeado la identidad de Bogotá. Su capilla, dedicada al Señor Caído, es visitada por miles de personas cada año, especialmente durante la Semana Santa."
            },
            cultura: {
              title: "Cultura",
              content: "El cerro de Monserrate es un punto de encuentro para la cultura colombiana. Desde su mercado de artesanías hasta su variada oferta gastronómica, este lugar celebra la diversidad cultural del país. También se ha convertido en un espacio para el deporte y la contemplación de la naturaleza, atrayendo a locales y turistas de todas partes del mundo."
            },
            mitos: {
              title: "Datos Curiosos",
              content: "El sendero ecológico de Monserrate tiene 2.4 km y es recorrido diariamente por cientos de personas. Además, los funiculares y teleféricos, inaugurados en 1929 y 1955 respectivamente, son considerados maravillas de la ingeniería para su época."
            },
            images: [
              "/img/hycMonserrate1.jpg",
              "/img/hycMonserrate2.jpg",
              "/img/hycMonserrate3.jpg"
            ]
          }
        ]
      },
      {
        ...
        descripcion: "Adéntrate en la riqueza histórica y cultural de Bogotá visitando el famoso Museo del Oro y recorriendo su icónico centro histórico.",
        ...
        descripciondetalles: [
          "Recorre la Plaza Bolívar, la Catedral Primada y otros monumentos emblemáticos.",
          "Descubre las asombrosas piezas precolombinas en el Museo del Oro, únicas en el mundo."
        ],
      ...
      },
      {
        ...
        descripcion: "Descubre el alma de Bogotá en La Candelaria, un barrio que fusiona la historia colonial con el vibrante arte callejero moderno.",
        ...
        descripciondetalles: [
          "Recorre calles llenas de historia y color, con casas coloniales y arte callejero.",
          "Conoce las tradiciones y leyendas que han dado forma a este emblemático barrio."
        ],
      ...
      },
      {
        ...
        descripcion: "Una experiencia única visitando la monumental Catedral de Sal, a solo una hora de Bogotá, una maravilla subterránea de la ingeniería moderna.",
        ...
        descripciondetalles: [
          ...
          "Descubre la historia de la sal y la ingeniería detrás de esta impresionante catedral subterránea."
        ],
      ...
      },
      {
        ...
        descripcion: "Vive Bogotá bajo las estrellas con este tour nocturno por sus miradores más altos y bares emblemáticos.",
        ...
        descripciondetalles: [
          "Visita al mirador de La Calera para una vista nocturna de la ciudad.",
          "Recorrido por los bares más populares de Usaquén y Chapinero."
        ],
      ...
      },
      {
        ...
        descripcion: "Sumérgete en los sabores tradicionales de Bogotá con este tour culinario por los mejores mercados y restaurantes locales.",
        ...
        descripciondetalles: [
          "Prueba platos como el ajiaco, tamales y postres tradicionales.",
      ...
      },
      {
        ...
        },
        {
          ...
          descripcion:
            ...
            bento: [
              "/img/paqueteArrieros1.jpg",
              "/img/paqueteArrieros2.jpg",
              "/img/paqueteArrieros3.jpg",
              "/img/paqueteArrieros4.jpg",
              "/img/paqueteArrieros5.jpg",
            ],
            descripciongeneral: [
              "Cancelación gratuita",
              "Reservar tu transporte privado",
              "Pasaporte múltiple al Parque de los Arrieros",
              "Ingreso al Parque de los Arrieros",
              "Ingreso privado y hospedaje",
            ],
            descripciondetalles: [
              "Cancela con hasta 24 horas de antelación y recibe un reembolso completo.",
              "Planes flexibles: reserva transporte privado de inmediato, sin que se te haga el cargo.",
            ...
            contentData: [
              {
                titulo: "Historia y Cultura del Parque de los arrieros en Quindio Colombia",
                description:
                  "El Parque Temático y Cultural Los Arrieros, ubicado en Quimbaya, Quindío, fue inaugurado en 2006 con el propósito de rescatar y preservar la historia y cultura de los arrieros, figuras esenciales en el desarrollo económico y social de Colombia durante los siglos XIX y XX.",
                historia: {
                  title: "Historia",
                  content:
                    "Los arrieros eran los encargados de transportar mercancías a lo largo del territorio colombiano, especialmente en las zonas montañosas del país, usando principalmente mulas y caballos.Este parque temático se creó con la intención de rendir homenaje a esa labor, que fue vital para la colonización antioqueña y el desarrollo del Eje Cafetero, una región que dependió fuertemente del trabajo de los arrieros para el transporte del café y otros productos. A través de espectáculos, exposiciones interactivas y representaciones teatrales, Los Arrieros busca recrear la vida, las costumbres y los valores de estos trabajadores, así como dar a conocer la importancia histórica de su oficio.",
                },
                cultura: {
                  title: "Cultura",
                  content:
                    "La cultura de los arrieros está profundamente arraigada en el Parque Temático y Cultural Los Arrieros. El parque es un tributo a su forma de vida, caracterizada por la resistencia, la tenacidad y la capacidad de adaptación a los difíciles terrenos montañosos del país. En el parque, los visitantes pueden observar dramatizaciones de los viajes que realizaban los arrieros, sus rutinas diarias, así como sus expresiones artísticas y musicales.El parque también destaca la importancia de los arrieros en la creación de caminos y rutas comerciales a lo largo del país, y cómo su cultura influyó en las tradiciones locales, incluidas las leyendas, música y gastronomía. Además, se rescatan valores importantes como el respeto por los animales, la naturaleza y el trabajo en comunidad.",
                },
                mitos: {
                  title: "Datos Curiosos",
                  content:
                    "Los espectáculos que se presentan en el parque incluyen representaciones teatrales que recrean situaciones típicas en la vida de los arrieros, desde los peligros de la montaña hasta los momentos de descanso en las fondas, además El parque permite a los visitantes interactuar con los animales que eran esenciales para el transporte de carga en el pasado, especialmente las mulas, que eran consideradas compañeras indispensables para los arrieros en sus largas travesías, y El parque celebra una jornada especial dedicada a honrar el trabajo de los arrieros, con actividades temáticas, desfiles de mulas, muestras de comida típica y narración de cuentos tradicionales.En Los Arrieros, los visitantes pueden seguir el recorrido típico de un arriero a través de distintas estaciones, donde se les enseña sobre las herramientas, vestimenta y técnicas utilizadas para transportar mercancías a través de la Cordillera de los Andes.",
                },
                images: [
                  "/img/hycArrieros1.jpg",
                  "/img/hycArrieros2.jpg",
                  "/img/hycArrieros3.jpg",
          ...
          },
          {
            ...
            descripcion:
              "Visita el Paisaje Cultural Cafetero de Colombia declarado Patrimonio de la Humanidad por la UNESCO y explora uno de los mejores pueblos del quindio",
              bento: [
                "/img/paqueteFilandia1.jpg",
                "/img/paqueteFilandia2.jpg",
                "/img/paqueteFilandia3.jpg",
                "/img/paqueteFilandia4.jpg",
                "/img/paqueteFilandia5.jpg",
              ],
              descripciongeneral: [
                "Cancelación gratuita",
                "Reservar tu transporte privado",
                "Caminata a las mejores atracciones del pueblo",
              ...
              contentData: [
                {
                  titulo: "Historia y Cultura del Tour Filandia en Quindio Colombia",
                  description:
                    "Filandia, conocida como La Colina Iluminada, es uno de los municipios más antiguos del departamento del Quindío. Fue fundada el 20 de agosto de 1878 por colonos antioqueños durante el proceso de colonización de la región.",
                  historia: {
                    title: "Historia",
                    content:
                      "En sus inicios, la economía de Filandia se centraba en la agricultura, especialmente en el cultivo del café, que aún hoy es uno de sus principales motores económicos. El nombre Filandia proviene del latín y significa hija de los Andes, en referencia a su privilegiada ubicación en la Cordillera Central.Filandia conserva gran parte de su arquitectura tradicional de estilo colonial antioqueño, con casas de fachadas coloridas y balcones en madera tallada, lo que la convierte en un atractivo turístico dentro del Eje Cafetero. A lo largo de su historia, ha logrado mantener viva su identidad cultural, en parte gracias al compromiso de sus habitantes por preservar las costumbres y el patrimonio arquitectónico.",
                  },
                  cultura: {
                    title: "Cultura",
                    content:
                      "La cultura de Filandia está estrechamente relacionada con la vida campesina y el cultivo del café, como es común en el Eje Cafetero. Sin embargo, Filandia también se destaca por ser un lugar de encuentro de tradiciones artesanales, especialmente en la fabricación de cestas y tejidos a mano, que se ha mantenido como una de las principales actividades de sus habitantes. La riqueza cultural del municipio se refleja en sus fiestas, celebraciones religiosas y en la fuerte presencia del folclore antioqueño.Uno de los aspectos más relevantes de la cultura local es la preservación del estilo de vida rural y el respeto por la naturaleza. El ecoturismo y el turismo cultural han cobrado gran importancia, con proyectos que buscan mostrar la autenticidad de la vida en Filandia, permitiendo a los visitantes participar en actividades relacionadas con la producción de café y conocer la biodiversidad de la región.",
                  },
                  mitos: {
                    title: "Datos Curiosos",
                    content:
                      "Filandia es conocida por su rica tradición artesanal, especialmente en la cestería. Las técnicas utilizadas por los artesanos locales han sido transmitidas de generación en generación y han hecho de este municipio un referente en el arte de trabajar con fibras naturales, demás de sus atractivos culturales, Filandia es también un destino ideal para los amantes de la naturaleza. Hay varios senderos ecológicos que permiten explorar los bosques nativos, observar aves y disfrutar del ambiente natural del Eje Cafetero. Debido a su arquitectura tradicional y paisajes, Filandia ha sido utilizada como locación para películas y producciones televisivas colombianas, lo que ha contribuido a su fama y atracción turística.",
                  },
                  images: [
                    "/img/hycFilandia.jpg",
                    "/img/hycFilandia2.webp",
                    "/img/hycFilandia3.jpg",
            ...
            },
            {
              ...
              descripcion:
                "Únase a nosotros en un recorrido inmersivo de 4 a 5 horas en la finca de cacao Evelyza, ubicada en la hermosa ciudad de Circasia, en lo profundo del Triángulo del Café de Colombia. Esta finca familiar se ha dedicado a la producción de cacao sostenible y orgánico, ofreciendo a los visitantes una mirada auténtica al proceso desde el grano hasta la barra",
                bento: [
                  "/img/paqueteFincaCacao1.jpg",
                  "/img/paqueteFincaCacao2.jpg",
                  "/img/paqueteFincaCacao3.jpg",
                  "/img/paqueteFincaCacao4.jpg",
                  "/img/paqueteFincaCacao5.jpg",
                ],
                descripciongeneral: [
                  "Cancelación gratuita",
                  "Caminata por la finca de cacao Evelyza",
                  "Proceso y enseñanza del Cacao hasta chocolate",
                  "Contenido multimedia",
                  "Hospedaje",
                ],
                descripciondetalles: [
                ...
                contentData: [
                  {
                    titulo: "Historia y Cultura de la finca de cacao Evelyza Quindio Colombia",
                    description:
                      "La Finca Evelyza, ubicada en el corazón del Quindío, Colombia, es un lugar que invita a descubrir las tradiciones agrícolas y la producción sostenible de cacao",
                    historia: {
                      title: "Historia",
                      content:
                        "Esta finca no solo se dedica al cultivo del cacao, sino que también integra cultivos de café, plátano y guadua, creando un ecosistema agrícola armonioso. A lo largo de los años, la finca ha mantenido un enfoque en la sostenibilidad, buscando prácticas que respeten el medio ambiente mientras producen productos de alta calidad. Los visitantes tienen la oportunidad de sumergirse en la historia de la finca y conocer los procesos que han sido parte de la tradición cacaotera en la región.",
                    },
                    cultura: {
                      title: "Cultura",
                      content:
                        "En la Finca Evelyza, la cultura local se fusiona con la tradición del cacao. El tour incluye un recorrido por las plantaciones donde se cultiva este fruto, y los visitantes tienen la oportunidad de aprender sobre el proceso artesanal de la producción de chocolate, desde la cosecha hasta la elaboración final. Además de la conexión con la naturaleza, este tour permite a los turistas interactuar con las prácticas agrícolas sostenibles que la finca promueve, destacando el papel del cacao en la vida de los campesinos del Quindío. La cultura cacaotera es una parte integral de la identidad de la región, y este recorrido ofrece una visión auténtica de cómo se produce un producto que forma parte de la tradición colombiana.",
                    },
                    mitos: {
                      title: "Datos Curiosos",
                      content:
                        "Los visitantes tienen la oportunidad de involucrarse directamente en el proceso de producción, desde tostar y moler los granos de cacao hasta moldearlos en deliciosas tabletas de chocolate. Además del cacao, la finca cultiva café, plátano y guadua, integrando estos cultivos en un sistema agrícola sostenible que beneficia tanto al medio ambiente como a las comunidades locales, además es importante resaltar que el tour está diseñado para ser accesible a personas con movilidad reducida, asegurando que todos puedan disfrutar de la experiencia, incluso aquellos que no pueden realizar caminatas largas.",
                    },
                    images: [
                      "/img/hycFincaCacao.webp",
                      "/img/hycFincaCacao2.jpg",
                      "/img/hycFincaCacao3.jpg",
    ...
    paquetes: [
      {
        ...
        descripcion: "Un destino natural ideal para disfrutar de caminatas, actividades al aire libre y paisajes espectaculares. Este parque es un refugio de biodiversidad y una de las joyas ecológicas de la región.",
      ...
      },
      {
        ...
        descripcion: "Sumérgete en la historia de transformación de la Comuna 13, con arte urbano, cultura y música. Este barrio, antes afectado por la violencia, es ahora un ejemplo mundial de resiliencia y arte social.",
      ...
      },
      {
        ...
        descripcion: "Descubre el proceso del café colombiano en una finca cercana a Medellín. Aprende sobre la siembra, cosecha y el tostado de uno de los cafés más premiados del mundo.",
      ...
      },
      {
        ...
        img: "/img/guatape.png",
        descripcion: "Una experiencia inolvidable visitando el colorido pueblo de Guatapé y escalando la icónica Piedra del Peñol.",
      ...
      },
      {
        ...
        descripcion: "Descubre la vibrante vida nocturna de Medellín con este tour especial.",
      ...
      },
      {
        ...
        descripcion: "Prueba los sabores únicos de la gastronomía paisa en este tour culinario.",
  ...
  },
  {
    ...
    paquetes: [
      {
        id: "paquete1",
        nombre: "Tour Salsa y Cultura",
        img: "/img/tourSalsa.png",
        descripcion: "Vive la esencia de la salsa caleña en un recorrido único que te llevará a explorar los rincones más emblemáticos de la ciudad. Disfruta de clases de salsa impartidas por expertos locales, mientras aprendes sobre la historia y la cultura que han convertido a Cali en la capital mundial de la salsa. Desde los bares más tradicionales hasta las escuelas de salsa más famosas, este tour es una inmersión completa en la vida nocturna y la pasión por la música.",
      ...
      {
        id: "paquete2",
        nombre: "Cristo Rey y Miradores",
        img: "/img/cristoRey.png",
        descripcion: "Disfruta de las vistas panorámicas más impresionantes de Cali en un recorrido por los miradores más emblemáticos de la ciudad, incluidos los famosos monumentos de Cristo Rey y Sebastián de Belalcázar. Estos lugares no solo ofrecen vistas espectaculares, sino que también son sitios cargados de historia, cultura y significado espiritual para los caleños.",
      ...
      {
        id: "paquete3",
        nombre: "Avistamiento de Aves en los Farallones",
        img: "/img/farallonesAves.png",
        descripcion: "Descubre la biodiversidad única de los Farallones de Cali, un refugio natural donde puedes observar aves endémicas y migratorias en su hábitat natural. Un recorrido guiado por expertos en ornitología te permitirá conocer la flora y fauna que hacen de este parque un lugar imprescindible para los amantes de la naturaleza.",
      ...
      {
        id: "paquete4",
        nombre: "Tour Gastronómico en Cali",
        img: "/img/gastronomiaCali.png",
        descripcion: "Disfruta de una experiencia culinaria única recorriendo los restaurantes más emblemáticos de Cali. Conoce los sabores de la comida tradicional del Valle del Cauca, con degustaciones de platos típicos como el sancocho, las empanadas y los aborrajados. Además, tendrás la oportunidad de aprender a preparar algunos de estos platillos en una clase de cocina valluna.",
      ...
      {
        id: "paquete5",
        nombre: "San Cipriano: Naturaleza y Río",
        img: "/img/sanCipriano.png",
        descripcion: "Vive una aventura única en San Cipriano, un paraíso natural donde la naturaleza exuberante y los ríos cristalinos te invitan a la relajación y el disfrute. Realiza un paseo en 'brujitas', vehículos locales que recorren los rieles del ferrocarril, y disfruta de actividades acuáticas como el tubing en el río.",
      ...
      {
        id: "paquete6",
        nombre: "Ruta del Vino en el Valle del Cauca",
        img: "/img/rutaVino.png",
        descripcion: "Embárcate en un recorrido sensorial por los viñedos del Valle del Cauca, una de las regiones vinícolas más prometedoras de Colombia. Durante este tour, aprenderás sobre el proceso de vinificación y disfrutarás de una serie de degustaciones de vinos y quesos locales.",
